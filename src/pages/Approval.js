        ...
        <div className='flex justify-center mb-[64px]'>
            ...
            <div className='flex w-[244px] h-[382px] bg-white border items-center flex-col rounded-lg relative'>
                    ...
                    <div className='w-full mt-[10px] ml-[20px]'>
                        ...
                        <a href="https://wa.me/085399904556" className='font-poppins font-regular text-[#1B8D42] text-[8px] mt-[7px] cursor-pointer'>https://chat.whatsapp.com/K3cDxMnIat1FVs0AhxLi55</a>
                    </div>
            </div>
            </div>
        </div>
